...
def create_basic_sandbox(nuage, prefix='integration-tests'):
    box = Namespace()

    # Create empty enterprise aka 'sandbox'.
    box.enterprise = get_object_dictionary(nuage.create_enterprise(random_name(prefix)))
